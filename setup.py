...
setup(
    ...
    description='Slip-aware odometry for skid-steer mobile robots with slam_toolbox integration',
    license='MIT',
    entry_points={
        'console_scripts': [
            'slip_odom_node = ssmr_slip_odom.slip_odom_node:main',
            'simple_encoder_odom_node = ssmr_slip_odom.simple_encoder_odom_node:main',
            ...
            'wasd_teleop_node = ssmr_slip_odom.wasd_teleop_node:main',
        ],
    },
)
